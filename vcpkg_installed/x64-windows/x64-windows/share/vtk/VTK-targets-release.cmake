...
set_target_properties(VTK::WrapHierarchy PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/vtk/vtkWrapHierarchy-9.3.exe"
  )
...
set_target_properties(VTK::WrapPython PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/vtk/vtkWrapPython-9.3.exe"
  )
...
set_target_properties(VTK::WrapPythonInit PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/vtk/vtkWrapPythonInit-9.3.exe"
  )
...
set_target_properties(VTK::ParseJava PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/vtk/vtkParseJava-9.3.exe"
  )
...
set_target_properties(VTK::WrapJava PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/vtk/vtkWrapJava-9.3.exe"
  )
...
set_target_properties(VTK::token PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtktoken-9.3.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtktoken-9.3.dll"
  )

list(APPEND _cmake_import_check_targets VTK::token )
list(APPEND _cmake_import_check_files_for_VTK::token "${_IMPORT_PREFIX}/lib/vtktoken-9.3.lib" "${_IMPORT_PREFIX}/bin/vtktoken-9.3.dll" )
...
set_target_properties(VTK::vtkTestOpenGLVersion PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/vtk/vtkTestOpenGLVersion-9.3.exe"
  )
...
set_target_properties(VTK::vtkProbeOpenGLVersion PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/vtk/vtkProbeOpenGLVersion-9.3.exe"
  )
...
set_target_properties(VTK::IOIOSS PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "VTK::FiltersCore;VTK::FiltersExtraction"
...
set_target_properties(VTK::IOFDS PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkIOFDS-9.3.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "VTK::IOCore;VTK::IOInfovis;VTK::vtksys"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkIOFDS-9.3.dll"
  )

list(APPEND _cmake_import_check_targets VTK::IOFDS )
list(APPEND _cmake_import_check_files_for_VTK::IOFDS "${_IMPORT_PREFIX}/lib/vtkIOFDS-9.3.lib" "${_IMPORT_PREFIX}/bin/vtkIOFDS-9.3.dll" )
...
set_target_properties(VTK::IOERF PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkIOERF-9.3.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "VTK::CommonSystem;VTK::vtksys"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkIOERF-9.3.dll"
  )

list(APPEND _cmake_import_check_targets VTK::IOERF )
list(APPEND _cmake_import_check_files_for_VTK::IOERF "${_IMPORT_PREFIX}/lib/vtkIOERF-9.3.lib" "${_IMPORT_PREFIX}/bin/vtkIOERF-9.3.dll" )
...
set_target_properties(VTK::ImagingOpenGL2 PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkImagingOpenGL2-9.3.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "VTK::CommonCore;VTK::CommonDataModel;VTK::CommonExecutionModel"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkImagingOpenGL2-9.3.dll"
  )

list(APPEND _cmake_import_check_targets VTK::ImagingOpenGL2 )
list(APPEND _cmake_import_check_files_for_VTK::ImagingOpenGL2 "${_IMPORT_PREFIX}/lib/vtkImagingOpenGL2-9.3.lib" "${_IMPORT_PREFIX}/bin/vtkImagingOpenGL2-9.3.dll" )
...
set_target_properties(VTK::FiltersTemporal PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkFiltersTemporal-9.3.lib"
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "VTK::CommonMisc"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkFiltersTemporal-9.3.dll"
  )

list(APPEND _cmake_import_check_targets VTK::FiltersTemporal )
list(APPEND _cmake_import_check_files_for_VTK::FiltersTemporal "${_IMPORT_PREFIX}/lib/vtkFiltersTemporal-9.3.lib" "${_IMPORT_PREFIX}/bin/vtkFiltersTemporal-9.3.dll" )
...
set_target_properties(VTK::FiltersParallelDIY2 PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/vtkFiltersParallelDIY2-9.3.lib"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/vtkFiltersParallelDIY2-9.3.dll"
  )

list(APPEND _cmake_import_check_targets VTK::FiltersParallelDIY2 )
list(APPEND _cmake_import_check_files_for_VTK::FiltersParallelDIY2 "${_IMPORT_PREFIX}/lib/vtkFiltersParallelDIY2-9.3.lib" "${_IMPORT_PREFIX}/bin/vtkFiltersParallelDIY2-9.3.dll" )
