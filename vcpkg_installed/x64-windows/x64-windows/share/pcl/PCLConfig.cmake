...
macro(find_boost)
  ...
  elseif(NOT BOOST_INCLUDEDIR)
    set(BOOST_INCLUDEDIR "${VCPKG_IMPORT_PREFIX}/include")
  endif()

  include(${CMAKE_CURRENT_LIST_DIR}/Modules/AdditionalBoostVersions.cmake)
  set(Boost_ADDITIONAL_VERSIONS "1.86.0" "1.86" ${Boost_ADDITIONAL_VERSIONS})
...
set(pcl_io_opt_dep png vtk OpenMP )
